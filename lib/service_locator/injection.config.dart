...
import 'package:money_lover_clone/features/transaction/presentation/state_managers/blocs/transaction_bloc.dart'
    as _i11;
import 'package:money_lover_clone/features/transaction/transaction.dart' as _i7;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i7.TransactionRemoteRepo>(() => _i8.FirebaseRemoteRepo());
    gh.lazySingleton<_i7.TransactionService>(
        () => _i9.FirebaseTransactionService(gh<_i7.TransactionRemoteRepo>()));
    gh.factory<_i10.AuthBloc>(() => _i10.AuthBloc(gh<_i4.AuthService>()));
    gh.factory<_i11.TransactionBloc>(
        () => _i11.TransactionBloc(gh<_i7.TransactionService>()));
    return this;
  }
}
